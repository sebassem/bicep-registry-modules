...
param tags resourceInput<'Microsoft.ResourceGraph/queries@2021-12-01'>.tags?
...
resource rgQuery_roleAssignments 'Microsoft.Authorization/roleAssignments@2022-04-01' = [
  for (roleAssignment, index) in (formattedRoleAssignments ?? []): {
    name: roleAssignment.?name ?? guid(rgQuery.id, roleAssignment.principalId, roleAssignment.roleDefinitionId)
    properties: {
