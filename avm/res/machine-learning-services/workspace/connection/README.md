...
| [`useWorkspaceManagedIdentity`](#parameter-useworkspacemanagedidentity) | bool | Indicates whether to use the workspace managed identity. |
...
### Parameter: `useWorkspaceManagedIdentity`
