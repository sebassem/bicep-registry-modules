  ...
  params: {
    ...
    roleAssignments: [
      ...
      }
      {
        ...
        description: 'Container Registry Contributor and Data Access Configuration Administrator'
      }
    ]
...
module acrNetworkByPassTasks 'br/public:avm/res/resources/deployment-script:0.5.1' = {
  params: {
    ...
    subnetResourceIds: networkingConfiguration.networkType == 'createNew'
      ? filter(
          newVnet.outputs.subnetResourceIds,
          subnetId =>
...
module aciJob 'br/public:avm/res/container-instance/container-group:0.2.1' = [
...
module deploymentScriptPrivateDNSZone 'br/public:avm/res/network/private-dns-zone:0.7.1' = if (contains(
  computeTypes,
  'azure-container-app'
...
module deploymentScriptStg 'br/public:avm/res/storage/storage-account:0.20.0' = if (contains(
  computeTypes,
  'azure-container-app'
          ...
          privateDnsZoneGroupConfigs: [
            {
              ...
              privateDnsZoneResourceId: networkingConfiguration.computeNetworking.?deploymentScriptPrivateDnsZoneResourceId ?? deploymentScriptPrivateDNSZone.outputs.resourceId
            }
          ]
        }
      }
